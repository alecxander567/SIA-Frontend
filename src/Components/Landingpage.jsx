        ...
        <section className="py-5 px-10 bg-gray-50" id="services">
          ...
          <div className="grid md:grid-cols-3 gap-10 text-center">
            <div className="shadow-lg p-6 rounded-lg bg-white">
              ...
              <p>
                Expert repair services for all kinds of power tools with quick
                turnaround time.
              </p>
            </div>
            <div className="shadow-lg p-6 rounded-lg bg-white">
              ...
              <p>
                Enjoy free and fast delivery for all your orders—straight to
                your doorstep.
              </p>
            </div>
            <div className="shadow-lg p-6 rounded-lg bg-white">
              ...
              <p>
                Schedule a live demo to experience the performance of our top
